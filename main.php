<?php
/**
 * Plugin Name: WPB Products Accordion for WooCommerce
 * Plugin URI: https://wpbean.com/downloads/wpb-woocommerce-product-accordain-pro/
 * Description: WPB Products Accordion for WooCommerce will add a nice and animated Woocommerce product accordain on your WordPress site. In accordain content it will show product details, image, price, add to cart button.
 * Author: wpbean
 * Version: 1.03
